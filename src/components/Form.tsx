...
const FormComponent: React.FC = () => {
    ...
    return (<Form onSubmit={submit}>
      ...
      <FormGroup row>
        ...
        <Col sm={10}>
          <Input type="text" name="username" id="username" placeholder="" value={username} onChange={change} onBlur={validate} />
        </Col>
      </FormGroup>
      <FormGroup row>
        <Label for="password" sm={2}>Password: </Label>
        <Col sm={10}>
          <Input type="password" name="password" id="password" placeholder="" value={password} onChange={change} onBlur={validate} />
        </Col>
      </FormGroup>
      <FormGroup row>
        <Label for="password" sm={2}>Re-Enter Password: </Label>
        <Col sm={10}>
          <Input type="password" name="password2" id="password2" placeholder="" value={password2} onChange={change} onBlur={validate} />
        </Col>
      </FormGroup>
